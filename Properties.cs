...
namespace SinCraft
{
    public static class SrvProperties
    {
                    ...
                    if (line != "" && line[0] != '#')
                    {
                        ...
                        switch (key.ToLower())
                        {
                            ...
                            case "agree-to-rules-on-entry":
                                try { Server.MustReadRules = bool.Parse(value); }
                            ...
                            case "dollar-before-dollar":
                                ...
                                break;
                            case "money-name":
                                if (value != "") Server.Currency = value;
                                break;
                            /*case "mono":
        ...
        public static void SaveProps(StreamWriter w)
        {
            ...
            w.WriteLine("money-name = " + Server.Currency);
            ...
            w.WriteLine("agree-to-rules-on-entry = " + Server.MustReadRules.ToString().ToLower());
