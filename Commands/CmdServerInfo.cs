...
namespace SinCraft.Commands
{
    public sealed class CmdServerInfo : Command
    {
        ...
        public override string[] aliases { get { return new string[] { "sinfo" }; } }
        ...
        public override void Use(Player p, string message)
        {
            ...
            else
            {
                ...
                Player.SendMessage(p, "This server's currency is: " + Server.Currency);
                Player.SendMessage(p, "This server runs on &bSinCraft" + Server.DefaultColor + ", which is based on &bMCLawl" + Server.DefaultColor + ".");
